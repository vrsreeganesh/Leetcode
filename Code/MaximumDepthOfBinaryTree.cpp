...
int main(){
    ...
    // lambda - function
    std::function<void(const TreeNode*, int)> fTraverse = [&fTraverse,
                                                           &maxcount](
        const TreeNode* root,
        int             count){
        ...
        ++count;                                                // updating length
        maxcount = max(maxcount, count);                        // checking maxlength

        fTraverse(root->left, count);                           // checking if we can go left
        fTraverse(root->right, count);                          // checking if we can go right
