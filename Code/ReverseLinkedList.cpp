...
int main(){
    ...
    // outlier cases
    if (head == nullptr)    {fPrintLinkedList("final-output = ", nullptr);}
    
    // setup
    auto previous_node  {static_cast<ListNode*>(nullptr)};
    auto original_next  {static_cast<ListNode*>(nullptr)};
    auto traveller      {head};
    ...
    while(traveller!= nullptr){
        ...
        original_next   = traveller->next;          // storing original next
        traveller->next = previous_node;            // making the current point to previous
        previous_node   = traveller;                // updating for next
        traveller       = original_next;            // updating the node
    }
    ...
    // returning head
    fPrintLinkedList("final-output = ", head);
