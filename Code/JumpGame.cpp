...
int main(){
    ...
    // setup
    Timer timer;                                                                // starting a timer
    int maxjumpdistance     {0};                                                // variable holding max-jump-distance
    int currjumpdistance    {0};                                                // variable holding max-jump-distance from here
    int finaloutput         {0};                                                // variable holding final verdict

    // going through the nums
    for(int i = 0; i<=maxjumpdistance && i<nums.size(); ++i){
