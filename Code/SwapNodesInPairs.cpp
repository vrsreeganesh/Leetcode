...
int main(){
    ...
    while(traveller){
        ...
        // jump-condition
        if (traveller->next == nullptr || traveller->next->next == nullptr) break;
        
        // swapping
        if (traveller->next         != nullptr && traveller->next->next   != nullptr){
            
            ListNode* a     = traveller->next;
            ListNode* b     = traveller->next->next;
            ListNode* c     = traveller->next->next->next;
